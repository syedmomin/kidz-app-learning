...
export const SvgBird = ({ isShadow }: { isShadow?: boolean } = {}) => <Svg width="140" height="140" viewBox="0 0 160 160"><Ellipse cx="80" cy="80" rx="30" ry="20" fill={isShadow ? '#111' : "#03A9F4"} stroke={isShadow ? '#111' : "#333"} strokeWidth="4" /><Circle cx="110" cy="65" r="15" fill={isShadow ? '#111' : "#03A9F4"} stroke={isShadow ? '#111' : "#333"} strokeWidth="4" /><Polygon points="125,60 140,65 125,70" fill={isShadow ? '#111' : "#FFC107"} stroke={isShadow ? '#111' : "#333"} strokeWidth="3" /><Path d="M 50 80 L 20 70 L 30 90 Z" fill={isShadow ? '#111' : "#03A9F4"} stroke={isShadow ? '#111' : "#333"} strokeWidth="3" /><Circle cx="115" cy="62" r="2" fill={isShadow ? '#111' : "#333"} /></Svg>;
...
export const SvgDog = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const c = isShadow ? '#111' : '#D2691E';
    ...
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            ...
            <Ellipse cx="80" cy="80" rx="10" ry="7" fill={isShadow ? '#111' : "#FF8A65"} stroke={s} strokeWidth="2" />
        </Svg>
    );
};
...
export const SvgGrape = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const c = isShadow ? '#111' : '#9C27B0';
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
...
export const SvgJar = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Rect x="55" y="40" width="50" height="10" rx="4" fill={isShadow ? '#111' : "#78909C"} stroke={s} strokeWidth="3" />
            <Path d="M 45 50 L 45 130 Q 45 140 80 140 Q 115 140 115 130 L 115 50 Z" fill={isShadow ? '#111' : "#B2EBF2"} stroke={s} strokeWidth="4" />
            <Ellipse cx="80" cy="95" rx="28" ry="20" fill={isShadow ? '#111' : "#FFC107"} stroke={s} strokeWidth="2" />
        </Svg>
    );
};

export const SvgKite = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Polygon points="80,15 130,80 80,130 30,80" fill={isShadow ? '#111' : "#E91E63"} stroke={s} strokeWidth="4" />
            <Path d="M 80 130 Q 95 145 80 155 Q 65 145 80 130" stroke={s} strokeWidth="3" fill={isShadow ? '#111' : "#FFC107"} />
...
export const SvgNest = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Path d="M 30 100 Q 80 60 130 100 Q 130 140 80 140 Q 30 140 30 100 Z" fill={isShadow ? '#111' : "#795548"} stroke={s} strokeWidth="4" />
            <Circle cx="65" cy="95" r="16" fill={isShadow ? '#111' : "#FFF9C4"} stroke={s} strokeWidth="3" />
            <Circle cx="95" cy="95" r="16" fill={isShadow ? '#111' : "#FFF9C4"} stroke={s} strokeWidth="3" />
            <Circle cx="80" cy="80" r="16" fill={isShadow ? '#111' : "#FFF9C4"} stroke={s} strokeWidth="3" />
        </Svg>
    );
};

export const SvgOwl = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const c = isShadow ? '#111' : '#8D6E63';
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Ellipse cx="80" cy="95" rx="42" ry="48" fill={c} stroke={s} strokeWidth="4" />
            <Circle cx="63" cy="72" r="20" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="3" />
            <Circle cx="97" cy="72" r="20" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="3" />
            <Circle cx="63" cy="72" r="10" fill={s} />
            <Circle cx="97" cy="72" r="10" fill={s} />
            <Polygon points="80,88 74,100 86,100" fill={isShadow ? '#111' : "#FFC107"} stroke={s} strokeWidth="2" />
...
export const SvgPig = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const c = isShadow ? '#111' : '#FFB3C1';
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Ellipse cx="80" cy="100" rx="50" ry="38" fill={c} stroke={s} strokeWidth="4" />
            <Circle cx="80" cy="68" r="35" fill={c} stroke={s} strokeWidth="4" />
            <Ellipse cx="80" cy="80" rx="15" ry="10" fill={isShadow ? '#111' : "#FF8A9A"} stroke={s} strokeWidth="2" />
...
export const SvgQuilt = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Rect x="30" y="30" width="100" height="100" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="4" />
            <Rect x="30" y="30" width="50" height="50" fill={isShadow ? '#111' : "#FF8A65"} stroke={s} strokeWidth="2" />
            <Rect x="80" y="30" width="50" height="50" fill={isShadow ? '#111' : "#42A5F5"} stroke={s} strokeWidth="2" />
            <Rect x="30" y="80" width="50" height="50" fill={isShadow ? '#111' : "#66BB6A"} stroke={s} strokeWidth="2" />
            <Rect x="80" y="80" width="50" height="50" fill={isShadow ? '#111' : "#FFA726"} stroke={s} strokeWidth="2" />
        </Svg>
    );
};

export const SvgRocket = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Path d="M 80 15 Q 55 50 55 90 L 105 90 Q 105 50 80 15 Z" fill={isShadow ? '#111' : "#EF5350"} stroke={s} strokeWidth="4" />
            <Rect x="55" y="90" width="50" height="30" fill={isShadow ? '#111' : "#BDBDBD"} stroke={s} strokeWidth="4" />
            <Path d="M 55 90 L 30 120 L 55 120 Z" fill={isShadow ? '#111' : "#FF9800"} stroke={s} strokeWidth="3" />
            <Path d="M 105 90 L 130 120 L 105 120 Z" fill={isShadow ? '#111' : "#FF9800"} stroke={s} strokeWidth="3" />
            <Circle cx="80" cy="65" r="14" fill={isShadow ? '#111' : "#E3F2FD"} stroke={s} strokeWidth="3" />
            <Path d="M 60 120 L 55 145 L 80 135 L 105 145 L 100 120" fill={isShadow ? '#111' : "#FF6D00"} stroke={s} strokeWidth="3" />
        </Svg>
    );
};

export const SvgTrain = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Rect x="25" y="50" width="110" height="65" rx="12" fill={isShadow ? '#111' : "#1E88E5"} stroke={s} strokeWidth="4" />
            <Rect x="35" y="60" width="30" height="25" rx="4" fill={isShadow ? '#111' : "#E3F2FD"} stroke={s} strokeWidth="3" />
            <Rect x="95" y="60" width="30" height="25" rx="4" fill={isShadow ? '#111' : "#E3F2FD"} stroke={s} strokeWidth="3" />
            <Circle cx="45" cy="120" r="14" fill={s} />
            <Circle cx="115" cy="120" r="14" fill={s} />
            <Rect x="72" y="35" width="16" height="20" fill={s} />
            <Circle cx="80" cy="30" r="8" fill={isShadow ? '#111' : "#FF5722"} stroke={s} strokeWidth="2" />
        </Svg>
    );
};

export const SvgUmbrella = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Path d="M 20 80 A 60 60 0 0 1 140 80 Z" fill={isShadow ? '#111' : "#7C4DFF"} stroke={s} strokeWidth="4" />
            <Path d="M 80 80 L 80 135 Q 80 148 65 148" stroke={s} strokeWidth="5" strokeLinecap="round" fill="none" />
            {!isShadow && <Path d="M 40 80 Q 60 60 80 80" stroke="#fff" strokeWidth="3" fill="none" />}
            {!isShadow && <Path d="M 80 80 Q 100 60 120 80" stroke="#fff" strokeWidth="3" fill="none" />}
        </Svg>
    );
};

export const SvgVase = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Path d="M 60 40 Q 30 70 35 110 Q 35 140 80 140 Q 125 140 125 110 Q 130 70 100 40 Z" fill={isShadow ? '#111' : "#42A5F5"} stroke={s} strokeWidth="4" />
            <Ellipse cx="80" cy="40" rx="22" ry="10" fill={isShadow ? '#111' : "#42A5F5"} stroke={s} strokeWidth="3" />
            <Path d="M 70 40 L 65 15" stroke={isShadow ? '#111' : "#4CAF50"} strokeWidth="4" strokeLinecap="round" />
            <Circle cx="60" cy="12" r="10" fill={isShadow ? '#111' : "#F44336"} stroke={s} strokeWidth="2" />
            <Path d="M 85 40 L 92 12" stroke={isShadow ? '#111' : "#4CAF50"} strokeWidth="4" strokeLinecap="round" />
            <Circle cx="96" cy="8" r="10" fill={isShadow ? '#111' : "#FFEB3B"} stroke={s} strokeWidth="2" />
        </Svg>
    );
};

export const SvgWatch = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Rect x="65" y="25" width="30" height="20" rx="4" fill={isShadow ? '#111' : "#555"} stroke={s} strokeWidth="2" />
            <Rect x="65" y="115" width="30" height="20" rx="4" fill={isShadow ? '#111' : "#555"} stroke={s} strokeWidth="2" />
            <Circle cx="80" cy="80" r="38" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="5" />
            {!isShadow && <Circle cx="80" cy="80" r="30" fill="#E8EAF6" />}
            <Path d="M 80 56 L 80 80 L 98 80" stroke={s} strokeWidth="4" strokeLinecap="round" />
        </Svg>
    );
};

export const SvgXylophone = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Rect x="25" y="55" width="110" height="18" rx="4" fill={isShadow ? '#111' : "#F44336"} stroke={s} strokeWidth="3" />
            <Rect x="30" y="80" width="100" height="16" rx="4" fill={isShadow ? '#111' : "#FF9800"} stroke={s} strokeWidth="3" />
            <Rect x="35" y="103" width="90" height="14" rx="4" fill={isShadow ? '#111' : "#FFEB3B"} stroke={s} strokeWidth="3" />
            <Rect x="40" y="124" width="80" height="12" rx="4" fill={isShadow ? '#111' : "#4CAF50"} stroke={s} strokeWidth="3" />
            <Circle cx="60" cy="46" r="8" fill={isShadow ? '#111' : "#78909C"} stroke={s} strokeWidth="2" />
            <Circle cx="100" cy="46" r="8" fill={isShadow ? '#111' : "#78909C"} stroke={s} strokeWidth="2" />
        </Svg>
    );
};

export const SvgYak = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const c = isShadow ? '#111' : '#5D4037';
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            ...
            <Ellipse cx="80" cy="78" rx="12" ry="8" fill={isShadow ? '#111' : "#795548"} stroke={s} strokeWidth="2" />
...
export const SvgZebra = ({ isShadow }: { isShadow?: boolean } = {}) => {
    const s = isShadow ? '#111' : '#333';
    return (
        <Svg width="140" height="140" viewBox="0 0 160 160">
            <Ellipse cx="80" cy="105" rx="48" ry="33" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="4" />
            <Circle cx="80" cy="65" r="33" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="4" />
            <Path d="M 52 50 L 42 28 L 62 42 Z" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="3" />
            <Path d="M 108 50 L 118 28 L 98 42 Z" fill={isShadow ? '#111' : "#fff"} stroke={s} strokeWidth="3" />
...
export const SvgMango = ({ isShadow, size = 140 }: { isShadow?: boolean, size?: number } = {}) => {
  const c = isShadow ? '#111' : '#FF6B35';
  const s = isShadow ? '#111' : '#333';
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200">
      <Ellipse cx="100" cy="135" rx="55" ry="50" fill={c} stroke={s} strokeWidth="4" />
      <Ellipse cx="100" cy="145" rx="32" ry="32" fill={isShadow ? '#111' : "#FFE9B0"} stroke={s} strokeWidth="3" />
      <Ellipse cx="78" cy="180" rx="14" ry="9" fill={isShadow ? '#111' : "#E65100"} stroke={s} strokeWidth="3" />
      <Ellipse cx="122" cy="180" rx="14" ry="9" fill={isShadow ? '#111' : "#E65100"} stroke={s} strokeWidth="3" />
      ...
      {!isShadow && <Ellipse cx="100" cy="88" rx="32" ry="26" fill="#FFF5E0" stroke="none" />}
